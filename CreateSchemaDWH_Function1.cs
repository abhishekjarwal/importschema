...
namespace CreateSchemaDWH
{
    public static class Function1
    {
        ...
        static string BlobconnectionString = "DefaultEndpointsProtocol=https;AccountName=marketplacestorage12;AccountKey=y0pWqAUrE5tzH2OlliO5vUMcvAVWPzZ1iy+A8W91M+y/ttQfQoAvwzCM6D8auhienfxTAKoSbxCNpr4efag9Ew==;EndpointSuffix=core.windows.net";
        //Data ware house connection string
        static string DWHconnectionString = "Server=marketplace-server.database.windows.net;Initial Catalog=marketplace-database;Persist Security Info=False;User ID=celebal;Password=password@123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
